...
const HOTSPOT_DESCRIPTIONS = {
  ...
  center:      "'그는 너무 늙고 지쳐 있었다. 사람들은 그가 조금 돌아버린 미친 늙은이라고 말들을 했다.'노마는 50년 세월의 동냥으로 그의 온 젊음을 써 버렸습니다.\n\n갈림길 중 하나를 선택하여 이동합니다.",
  bottomLeft:  "'그는 그의 집을 먹어버린 셈이었다.'\n도시화의 그림자는 노마는 집을 앗아가고, 그는 자신의 존재를 집 삼습니다.\n\n건물 카드 한 장 또는 점수 카드 세 장을 버립니다.",
  bottomRight: "'그는 분명히 액자가 걸릴 만큼 튼튼하게 못을 박았음에도 서너 번 더 못질을 했었다.'\n동냥을 하며 모은 돈으로 노마는 새장 같은 판자집 하나를 얻어냈습니다.\n\n건물 카드를 한 장 획득합니다.",
};
